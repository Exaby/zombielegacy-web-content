...
xmlhttp.onload = function() {
  ...
  document.getElementById("players-max").innerHTML = (servers.zl_zs.PlayerCount + ' Players Online')
  document.getElementById("zl_zs-name").innerHTML = (servers.zl_zs.ServerName)
  document.getElementById("zl_zs-map").innerHTML = (servers.zl_zs.Map)
  document.getElementById("zl_zs-players").innerHTML = (servers.zl_zs.PlayerCount + ' / ' + servers.zl_zs.MaxPlayers)
  document.title = ("/Portal/ " + servers.zl_zs.PlayerCount + " Online")
  document.getElementById("zl_zs-steam").href = ("steam://connect/" + servers.zl_zs.IP)
